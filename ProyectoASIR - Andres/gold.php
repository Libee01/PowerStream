...
<body>
    ...
    if ($result_drama->num_rows > 0) { 
            ...
            ?>
                        <div class="box-2gold <?php if($i == 0) echo 'active'; ?>">
                            <div class="content">
                                <a href="reproductor.php?id=<?php echo $row['id']; ?>">
                                    <img id="arriba" src="php/img/<?php echo $row['portada']; ?>" alt="<?php echo $row['titulo']; ?>">
                                </a>
    ...
    if ($result_terror->num_rows > 0) { 
            ...
            ?>
                        <div class="box-3gold <?php if($i == 0) echo 'active'; ?>">
                            <div class="content">
                                <a href="reproductor.php?id=<?php echo $row['id']; ?>">
                                    <img id="arriba" src="php/img/<?php echo $row['portada']; ?>" alt="<?php echo $row['titulo']; ?>">
                                </a>
    ...
    if ($result_romanticas->num_rows > 0) { 
            ...
            ?>
                        <div class="box-4gold <?php if($i == 0) echo 'active'; ?>">
                            <div class="content">
                                <a href="reproductor.php?id=<?php echo $row['id']; ?>">
                                    <img id="arriba" src="php/img/<?php echo $row['portada']; ?>" alt="<?php echo $row['titulo']; ?>">
                                </a>
    ...
    if ($result_comedia->num_rows > 0) { 
            ...
            ?>
                        <div class="box-5gold <?php if($i == 0) echo 'active'; ?>">
                            <div class="content">
                                <a href="reproductor.php?id=<?php echo $row['id']; ?>">
                                    <img id="arriba" src="php/img/<?php echo $row['portada']; ?>" alt="<?php echo $row['titulo']; ?>">
                                </a>
    ...
    if ($result_aventuras->num_rows > 0) { 
            ...
            ?>
                        <div class="box-6gold <?php if($i == 0) echo 'active'; ?>">
                            <div class="content">
                                <a href="reproductor.php?id=<?php echo $row['id']; ?>">
                                    <img id="arriba" src="php/img/<?php echo $row['portada']; ?>" alt="<?php echo $row['titulo']; ?>">
                                </a>
