        ...
        //--------------------------Tercera img
            ...
            $copiarFichero3 = false;
                ...
                if (is_uploaded_file($_FILES['img3']['tmp_name'])) {
                    $nombreDirectorio = "php/img/";
                    $nombreFichero3 = $_FILES['img3']['name'];
                    $copiarFichero3 = true;
                } else if ($_FILES['img3']['error'] == UPLOAD_ERR_FORM_SIZE) {
                    $maxsize = $_REQUEST['MAX_FILE_SIZE'];
                    $errores = $errores . "   <LI>El tamaño del fichero supera el límite permitido ($maxsize bytes)\n";
                ...
                if ($errores != "") {
                    ...
                    // Mover foto a su ubicación definitiva
                    if ($copiarFichero3) {
                        move_uploaded_file($_FILES['img3']['tmp_name'], $nombreDirectorio . $nombreFichero3);
                    }
                }
            ...
            $query="insert into prueba (titulo,portada,descripcion,categoria,img_publi,nom_publi,tipo) values ('$titulo','$nombreFichero','$descripcion','$categoria','$nombreFichero2','$nombreFichero3','$tipo')";
            //echo "$query.<br> ";
