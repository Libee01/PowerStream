                ...
                ?>
                    ...
                    <?php } ?>
                        <div class="content">
                            ...
                            <h3><?php echo $row['titulo']; ?></h3>
                            <div class="opciones">
                                <button class="boton" onclick="reproducirPelicula()">Reproducir</button>
                                <button class="boton" onclick="añadirALista(<?php echo $row['id']; ?>, '<?php echo $row['titulo']; ?>', '<?php echo $row['portada']; ?>', '<?php echo $row['categoria']; ?>', '<?php echo $row['img_publi']; ?>')">Añadir a la lista</button>
                            </div>
                        </div>
                    </div>
                <?php 
