...
function añadirALista(id, id_usuario, titulo, portada, categoria, img_publi) {
    ...
    xhr.send("id=" + id + "&id_usuario=" + id_usuario + "&titulo=" + titulo + "&portada=" + portada + "&categoria=" + categoria + "&img_publi=" + img_publi);
}
